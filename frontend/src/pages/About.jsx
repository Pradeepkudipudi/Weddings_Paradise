...
import Logo from  '../Components/DestinyPlaces/wedlogo.jpg'
    ...
    <div className="mt-32">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 ">
        ...
        <div className="flex flex-col justify-center gap-6 md:w2/4 text-sm text-gray-600">
          <p>
            Welcome to DocMeet, your trusted partner in managing your healthcare
            needs conveniently and efficiently. At DocMeet, we understand the
            challenges individuals face when it comes to scheduling doctor
            appointments and managing their health records.
          </p>
          <p>
            DocMeet is committed to excellence in healthcare technology. We
            continuously strive to enhance our platform, integrating the latest
            advancements to improve user experience and deliver superior
            service. Whether you're booking your first appointment or managing
            ongoing care, DocMeet is here to support you every step of the way.
          </p>
          <b className="text-gray-700">Our Vision</b>
          <p>
            Our vision at DocMeet is to create a seamless healthcare experience
