...
import Logo from "../DestinyPlaces/wedlogo.jpg"
const Footer = () => {
  return (
    <footer className="md:mx-10 ">
      <div className="flex flex-col sm:grid sm:grid-cols-3 gap-14 my-10 mt-40 text-sm text-gray-600  items-center px-5 ">
        {/* Left Section */}
        
        <div>
          <img src={Logo} alt="Company Logo" className="mb-5 w-40" /> 
