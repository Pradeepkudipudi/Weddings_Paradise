...
// import ResponsiveMenu from "../ResponsiveMenu";
// import { AppContext } from "../../Context/appcontext";
// import dropdown from "../../assets/dropdown.png";    // Ensure image paths are correct

// // Image imports (used for background in main nav)
// import img1 from "../../../celebrations/coverwall1.jpg";
// import img2 from "../../../celebrations/coverwall2.jpg";
// import img3 from "../../../celebrations/coverr.jpg";
...
//   // For main navbar background logic
...
//     <>
//       <div
//         className={`relative w-full ${isHomePage ? "bg-opacity-3" : ""}`}
//         style={{
//           backgroundImage: isHomePage ? `url(${images[currentImageIndex]})` : "none",
//         }}
//       >
//         <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${navbarBg} p-4`}>
//           <div className="flex justify-between items-center">
//             <div
//               onClick={() => navigate("/login")}
//               className="flex items-center gap-4 font-bold uppercase cursor-pointer"
